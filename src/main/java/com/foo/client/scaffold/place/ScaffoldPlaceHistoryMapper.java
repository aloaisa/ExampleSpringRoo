package com.foo.client.scaffold.place;
 ...
 * {@link com.foo.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link com.foo.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link com.foo.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
