...
public abstract class TimerEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends com.foo.client.scaffold.place.ProxyEditView<com.foo.client.managed.request.TimerProxy, V>> extends ProxyEditView<TimerProxy, V> {
    }
}
