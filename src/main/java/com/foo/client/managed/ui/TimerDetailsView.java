...
import com.foo.client.managed.ui.TimerDetailsView.Binder;
...
public class TimerDetailsView extends TimerDetailsView_Roo_Gwt {
    ...
    private static com.foo.client.managed.ui.TimerDetailsView instance;
    ...
    public static com.foo.client.managed.ui.TimerDetailsView instance() {
        if (instance == null) {
