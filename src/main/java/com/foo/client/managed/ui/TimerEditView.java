...
import com.foo.client.managed.ui.TimerEditView.Binder;
...
public class TimerEditView extends TimerEditView_Roo_Gwt {
    ...
    private static com.foo.client.managed.ui.TimerEditView instance;
    ...
    public static com.foo.client.managed.ui.TimerEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<com.foo.client.managed.request.TimerProxy, com.foo.client.managed.ui.TimerEditView> createEditorDriver() {
